<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="enclase.login" %>
                        ...
                        <table cellpadding="0">
                            ...
                            <tr>
                                <td align="right" colspan="2">
                                    <asp:Button ID="LoginButton" class="btn btn-primary" runat="server" CommandName="Login" Text="Inicio de sesión" ValidationGroup="Login1" />
                                </td>
                            </tr>
                        </table>
                    </td>
